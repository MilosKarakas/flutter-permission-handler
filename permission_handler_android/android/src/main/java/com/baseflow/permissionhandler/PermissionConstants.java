...
final class PermissionConstants {
    ...
    static final int PERMISSION_GROUP_CAMERA = 2;
    static final int PERMISSION_GROUP_CONTACTS = 3;
    static final int PERMISSION_GROUP_LOCATION = 4;
    static final int PERMISSION_GROUP_LOCATION_ALWAYS = 5;
    static final int PERMISSION_GROUP_LOCATION_WHEN_IN_USE = 6;
    static final int PERMISSION_GROUP_MEDIA_LIBRARY = 7;
    static final int PERMISSION_GROUP_MICROPHONE = 8;
    static final int PERMISSION_GROUP_PHONE = 9;
    static final int PERMISSION_GROUP_PHOTOS = 10;

    static final int PERMISSION_GROUP_PHOTOS_ADD_ONLY = 11;
    static final int PERMISSION_GROUP_REMINDERS = 12;
    static final int PERMISSION_GROUP_SENSORS = 13;
    static final int PERMISSION_GROUP_SMS = 14;
    static final int PERMISSION_GROUP_SPEECH = 15;
    static final int PERMISSION_GROUP_STORAGE = 16;
    static final int PERMISSION_GROUP_IGNORE_BATTERY_OPTIMIZATIONS = 17;
    static final int PERMISSION_GROUP_NOTIFICATION = 18;
    static final int PERMISSION_GROUP_ACCESS_MEDIA_LOCATION = 19;
    static final int PERMISSION_GROUP_ACTIVITY_RECOGNITION = 20;
    static final int PERMISSION_GROUP_UNKNOWN = 21;
    static final int PERMISSION_GROUP_BLUETOOTH = 22;
    static final int PERMISSION_GROUP_MANAGE_EXTERNAL_STORAGE = 23;
    static final int PERMISSION_GROUP_SYSTEM_ALERT_WINDOW = 24;
    static final int PERMISSION_GROUP_REQUEST_INSTALL_PACKAGES = 25;
    static final int PERMISSION_GROUP_APP_TRACK_TRANSPARENCY = 26;
    static final int PERMISSION_GROUP_CRITICAL_ALERTS = 27;
    static final int PERMISSION_GROUP_ACCESS_NOTIFICATION_POLICY = 28;
    static final int PERMISSION_GROUP_BLUETOOTH_SCAN = 29;
    static final int PERMISSION_GROUP_BLUETOOTH_ADVERTISE = 30;
    static final int PERMISSION_GROUP_BLUETOOTH_CONNECT = 31;
    static final int PERMISSION_GROUP_NEARBY_WIFI_DEVICES = 32;
    static final int PERMISSION_GROUP_VIDEOS = 33;
    static final int PERMISSION_GROUP_AUDIO = 34;
    static final int PERMISSION_GROUP_SCHEDULE_EXACT_ALARM = 35;
    static final int PERMISSION_GROUP_SENSORS_ALWAYS = 36;
